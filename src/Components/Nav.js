    ...
    <div>
      ...
      <div className='nav'>
          <Menu right isOpen={this.state.menuOpen} onStateChange={(state) => this.handleStateChange(state)} >
            ...
            <NavLink to='/add' activeClassName='active' className="menu-item" onClick={this.handleCloseMenu}>
                    New Question
            </NavLink>
            <NavLink to='/leaderboard' activeClassName='active' className="menu-item" onClick={this.handleCloseMenu}>
                    LeaderBoard
            </NavLink>

            {user && 
                  <NavLink to='/signin' activeClassName='active' className='menu-item' onClick={this.handleLogout} >
                    Logout
                  </NavLink>
            }
